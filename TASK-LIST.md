This is the list with the current tasks for the project. Feel free to add/correct any of them.
...
7. Abstraction levels - implement interfaces, inheritance and generics where needed, and remove them wherever they're not
